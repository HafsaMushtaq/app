                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-md-offset-6">
                                            <div class="slide-content">
                                                <h2>We are to help you!</h2>
                                                <p>With the development of science and technology, the cars have already become the important component in our daily life.. </p>
                                                <p>And to keep it up to date we are here!</p>
                            ...
                            <div class="slide-text">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-6 col-md-offset-6">
                                            <div class="slide-content">
                                                <h2>Get everything on a click</h2>
                                                <p>Whenever you need anything for ur car.. we are just a click away!</p>
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-6 col-md-offset-6">
                                            <div class="slide-content">
                                                <h2>Originality!</h2>
                                                <p>100% original products! we value your trust.</p>
